...
if (isset($_POST['update'])) {
  ...
  if (empty($cat)) {
    echo "must Need value";
      ...
      $catid= "UPDATE `writers` SET `deleted`=NULL WHERE id='".$_GET['id']."' ORDER BY `created` DESC ";
    //   echo $catid;
        ...
        <div id="body" class="active">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <?php
if (isset($_GET['id'])) {
    $sql= "SELECT * FROM `writers` WHERE id='".$_GET['id']."'";
    // echo $sql;
       ...
       $catlist = $result->fetch_assoc();
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <input class="form-control my-3" type="text" name="cate" value="<?php echo $catlist['writername'] ?>">
