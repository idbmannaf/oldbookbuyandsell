                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number"><?php
                                                                        ...
                                                                        $newq = "SELECT count(*) as totalbook FROM books where privacy='1'";
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number"><?php
                                                                        ...
                                                                        $u = "SELECT count(*) as totalusers FROM users where role = '1'";
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number"><?php
                                                                        ...
                                                                        $w = "SELECT count(*) as totalwriter FROM writers where privacy='1'";
