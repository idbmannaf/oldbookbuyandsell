            ...
            <div class="content">
                <div class="container">
                    <div class="page-title">
                        <h3> Public Books <span>(<?php

$newq = "SELECT count(*) as publicbook FROM books where privacy = 1";
...
?>)</span>
                        <a href="addbooks.php" class="btn btn-sm btn-outline-primary float-right">Add Users</a>
                                        ...
                                        if ($result->num_rows >0) {
                                           while($rows = $result->fetch_assoc()){
                                               ...
                                               <td class="text-right">
                                                   ...
                                                   <a title="Private" href="private.php?id='.$rows['id'].'" class="btn btn-outline-danger btn-rounded"><i class="fas fa-thumbs-down"></i></a>
                                               </td>
                                           </tr>';
