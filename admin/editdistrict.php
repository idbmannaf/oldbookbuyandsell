...
if (isset($_POST['update'])) {
  ...
  if (empty($cat)) {
    echo "must Need value";
      ...
      $catid= "UPDATE `district` SET `disname`= '".$cat."' WHERE id='".$_GET['id']."' LIMIT 1";
    //   echo $catid;
        ...
        <div id="body" class="active">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <?php
if (isset($_GET['id'])) {
    $sql= "SELECT * FROM `district` WHERE id='".$_GET['id']."'";
    // echo $sql;
       ...
       $catlist = $result->fetch_assoc();
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <label for="categories">Update District</label>
                            <input class="form-control my-3" type="text" name="cate" value="<?php echo $catlist['disname'] ?>">
