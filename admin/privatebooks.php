            ...
            <div class="content">
                <div class="container">
                    <div class="page-title">
                        <h3> Private Books <span>(<?php

$newq = "SELECT count(*) as publicbook FROM books where privacy = '2'";
...
?>)</span>
                        <a href="addbooks.php" class="btn btn-sm btn-outline-primary float-right">Add Books</a>
                                        ...
                                        if ($result->num_rows >0) {
                                           while($rows = $result->fetch_assoc()){
                                               ...
                                               <td class="text-right">
                                                   ...
                                                   <a title="Edit" href="edit.php?id='.$rows['id'].'" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></a> <br>
                                                   <a title="Delete" href="delete.php?id='.$rows['id'].'" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></a>
                                                   <a title="Public" href="privatetopublic.php?id='.$rows['id'].'" class="btn btn-outline-danger btn-rounded"><i class="fas fa-thumbs-up"></i></i></a>
                                               </td>
                                           </tr>';
