                    ...
                    <div class="box box-primary">
                        ...
                        if ($res->num_rows >0) {
                            while($catlist = $res->fetch_assoc()){
                                ...
                                <a href="editdistrict.php?id='.$catlist['id'].'" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></a>
                                 <a href="deletedistrict.php?id='.$catlist['id'].'" class="btn btn-outline-info btn-rounded" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></a>
                                                       </td>
                                </tr>';
                            }
                        }
