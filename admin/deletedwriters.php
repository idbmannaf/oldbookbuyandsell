    ...
    //   echo Database::validationMessage(Session::getSessionData('usermsg'),'primary');
                    ...
                    <div class="box box-primary">
                        ...
                        <table class="table table-striped">
                                ...
                                $pagi = "SELECT COUNT(*) AS total FROM writers WHERE privacy='3'";
                                ...
                                $sql = "SELECT `id`, `writername`, `privacy`, `created`, `updated`, `deleted`,date(`created`) as dat FROM `writers` WHERE privacy='3' ORDER BY created DESC LIMIT " . $recordStart . "," . PAGE_SIZE . "";
                                ...
                                <a title="Edit" href="editwriters.php?id=' . $catlist['id'] . '" class="btn btn-outline-info btn-rounded"><i class="fas fa-pen"></i></a>
                                 <a title="Public" href="writerdtop.php?id=' . $catlist['id'] . '" class="btn btn-outline-info btn-rounded" class="btn btn-outline-danger btn-rounded"><i class="fas fa-thumbs-up"></i></a>
                                                       </td>
                                </tr>';
                                    }
                                }
