    ...
    <section class="main-cat clearfix">
        <div class="container container-md">
            ...
            <div class="cate shadow overflow-hidden">
                ...
                <a class="text-end fs-50 cattoggle" href="#">SubCategories <i class="fas fa-bars"></i></a>
...
<div id="hello"></div>
    ...
    <script>
        ...
        // var numberofitem= $("#tt .post-item").length;
